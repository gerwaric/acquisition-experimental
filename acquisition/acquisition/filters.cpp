...
Filter::Filter(QObject* parent) : QObject(parent)
{
    ...
    m_heist_contract_objective_values = {
        "Any",
        "Moderate Value",
        "High Value",
        "Precious",
