#include <acquisition/utils/oauth2.h>
...
#include <QtNetworkAuth/6.8.0/QtNetworkAuth/private/qoauth2authorizationcodeflow_p.h>
...
/*!
    ...
    object \a parent.
*/
MyOAuth2AuthorizationCodeFlow::MyOAuth2AuthorizationCodeFlow(QObject* parent) :
    MyOAuth2AuthorizationCodeFlow(nullptr,
        parent)
{}
...
*/
MyOAuth2AuthorizationCodeFlow::MyOAuth2AuthorizationCodeFlow(QNetworkAccessManager* manager,
    QObject* parent) :
    MyOAuth2AuthorizationCodeFlow(QString(),
        manager,
        parent)
{}
...
*/
MyOAuth2AuthorizationCodeFlow::MyOAuth2AuthorizationCodeFlow(const QString& clientIdentifier,
    QNetworkAccessManager* manager,
    QObject* parent) :
...
*/
MyOAuth2AuthorizationCodeFlow::MyOAuth2AuthorizationCodeFlow(const QUrl& authenticateUrl,
...
*/
MyOAuth2AuthorizationCodeFlow::~MyOAuth2AuthorizationCodeFlow()
{}
...
*/
QUrl MyOAuth2AuthorizationCodeFlow::accessTokenUrl() const
{
