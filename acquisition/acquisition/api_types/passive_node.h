...
namespace poe_api{
    ...
    struct PassiveNode {
        ...
        std::optional<std::vector<poe_api::PassiveNode::Mastery>> masteryEffects; // ? array of object
        ...
        std::optional<poe_api::PassiveNode::ClusterJewel> expansionJewel; // ? object cluster jewel information
