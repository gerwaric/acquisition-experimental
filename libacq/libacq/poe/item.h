...
#include <libacq/poe/cruciblenode.h>
#include <libacq/poe/frametype.h>
#include <libacq/poe/itemproperty.h>
#include <libacq/poe/itemsocket.h>
...
namespace poe_api {
    ...
    struct Item {
        ...
        struct LogbookMods {
            ...
            poe_api::Item::LogbookFaction faction; // object
        ...
        struct HybridInfo {
            ...
            std::optional<std::vector<poe_api::ItemProperty>> properties; // ? array of ItemProperty
        ...
        std::optional<std::vector<poe_api::ItemSocket>> sockets; // ? array of ItemSocket
        std::optional<std::vector<poe_api::Item>> socketedItems; // ? array of Item
        QString name; // string
        ...
        std::optional<std::vector<poe_api::ItemProperty>> properties; // ? array of ItemProperty
        std::optional<std::vector<poe_api::ItemProperty>> notableProperties; // ? array of ItemProperty
        std::optional<std::vector<poe_api::ItemProperty>> requirements; // ? array of ItemProperty
        std::optional<std::vector<poe_api::ItemProperty>> additionalProperties; // ? array of ItemProperty
        std::optional<std::vector<poe_api::ItemProperty>> nextLevelRequirements; // ? array of ItemProperty
        std::optional<int> talismanTier; // ? int
        std::optional<std::vector<poe_api::Item::Rewards>> rewards; // ? array of object
        std::optional<QString> secDescrText; // ? string
        std::optional<std::vector<QString>> utilityMods; // ? array of string
        std::optional<std::vector<poe_api::Item::LogbookMods>> logbookMods; // ? array of object
        ...
        std::optional<std::vector<poe_api::Item::UltimatumMods>> ultimatumMods; // ? array of object
        std::optional<std::vector<QString>> explicitMods; // ? array of string
        ...
        std::optional<poe_api::Item::IncubatingInfo> incubatedItem; // ? object
        std::optional<poe_api::Item::ScourgedInfo> scourged; // ? object
        std::optional<poe_api::Item::CrucibleInfo> crucible; // ? object
        std::optional<bool> ruthless; // ? bool always true if present
        poe_api::FrameType frameType; // ? uint as FrameType
        std::optional<QString> artFilename; // ? string
        std::optional<poe_api::Item::HybridInfo> hybrid; // ? object
        std::optional<poe_api::Item::ExtendedInfo> extended; // ? object only present in the Public Stash API
